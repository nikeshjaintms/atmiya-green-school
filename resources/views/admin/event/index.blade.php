                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                        {{-- @can('create-brand') --}}
                        <a href="{{ route('admin.event.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary"><i class="fas fa-plus"></i> Events</a>
                        {{-- @endcan --}}
...
<script>
    function deletetestimonial_info(id) {
        var url = '{{ route("admin.event.delete", "id") }}'.replace("id", id);
