                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                        {{-- @can('create-brand') --}}
                        <a href="{{ route('admin.activity.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary"><i class="fas fa-plus"></i> Activity </a>
                        {{-- @endcan --}}
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                  {{-- @can('edit-brand') --}}
                                <a href="{{ route('admin.activity.edit', $item->id) }}" class="btn btn-lg btn-link btn-primary">
                                  <i class="fa fa-edit">
                                </i></a>
                                  {{-- @endcan --}}
                                      {{-- @can('delete-brand') --}}
...
<script>
    function deletedepartment_info(id) {
        var url = '{{ route("admin.activity.delete", "id") }}'.replace("id", id);
