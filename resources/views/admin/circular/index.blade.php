    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Circulars</h3>
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                        {{-- @can('create-brand') --}}
                        <a href="{{ route('admin.circular.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary"><i class="fas fa-plus"></i> Circulars</a>
                        {{-- @endcan --}}
...
<script>
    function deletetestimonial_info(id) {
        var url = '{{ route("admin.circular.delete", "id") }}'.replace("id", id);
