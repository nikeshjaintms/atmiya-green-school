            ...
            <table cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                ...
                <tr>
                    <td style="padding: 30px;">
                        <h2 style="font-size: 20px; color: #333;">Hello {{ $details['name'] }},</h2>

                        <p style="font-size: 16px; color: #555;">
                            Thank you for reaching out to Atmiya Green School.
                        </p>

                        @if (!empty($details['message']))
                            <p style="font-size: 16px; color: #555;">Here is our response to your message:</p>
                            <blockquote style="margin: 15px 0; padding: 15px; background-color: #f9f9f9; border-left: 4px solid #007b5e; color: #333;">
                                {{ $details['message'] }}
                            </blockquote>
                        @endif
                        ...
                        <p style="font-size: 16px; color: #555;">
                            Best regards,<br>
                            <strong>Atmiya Green School</strong>
                        </p>
                    </td>
                </tr>
                <tr>
